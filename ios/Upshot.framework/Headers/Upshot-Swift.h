...
- (void)fetchUsernotificationsWithAppuid:(NSString * _Nonnull)appuid notificationId:(NSString * _Nonnull)notificationId completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
